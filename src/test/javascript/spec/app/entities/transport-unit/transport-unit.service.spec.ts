...
describe('Service Tests', () => {
    describe('TransportUnit Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TransportUnitService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/transport-units';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TransportUnit', () => {
                service.create(new TransportUnit(null)).subscribe(received => {
            ...
            it('should update a TransportUnit', () => {
                service.update(new TransportUnit(123)).subscribe(received => {
            ...
            it('should return a TransportUnit', () => {
            ...
            it('should return a list of TransportUnit', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TransportUnit(123)]);
            });
