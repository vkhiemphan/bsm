...
public class BuyContactForSaleDTO implements Serializable {
    ...
    private Long amountSaleInContact;

    public BuyContactForSaleDTO() {
    }

    public BuyContactForSaleDTO(BuyContact buyContact) {
    ...
    public Long getAmountSaleInContact() {
        return amountSaleInContact;
    }

    public void setAmountSaleInContact(Long amountSaleInContact) {
        this.amountSaleInContact = amountSaleInContact;
    }
}
